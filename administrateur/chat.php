        ...
        <div class="row mt-5 ">
            ...
            <div class="col-md-6 visible-lg visible-md liste_commande" style="padding-top:30px">
                ...
                <?php
                    ...
                    $select=$bdd->PREPARE("SELECT * from bon_command  ORDER BY id_bondecommande DESC");
                    $select->EXECUTE();
                ...
                <div class="button_commande bg-primary"
                    ...
                    <p class="btn-group ">
                        ...
                        <a
                            href="?commande=<?=$commande["id_bondecommande"];?>&amp;destine=client&amp;identifiant_client=<?=$commande["client"];?>"><button
                    ...
                    <div id="Demo<?=$i;?>" class="w3-hide">
                        ...
                        <?php
                                ...
                                $select->EXECUTE(array($commande["client"],$commande["id_bondecommande"]));
            ...
            <div class="col-md-6">
                <div class="row bg-primary">
                    ...
                    if(isset($_GET['identifiant_client']) && is_int(intval($_GET['identifiant_client'])))
                    {
                        $select = $bdd->PREPARE("SELECT * FROM clients where id_client=? ");
                        $select->EXECUTE(array($_GET['identifiant_client']));

                        $client=$select->fetch();

                        $nom="Client :".$client['nom']." ".$client['prenoms'];

                        


                    }
                    if(isset($_GET['numero_vendeur']) && is_int(intval($_GET['numero_vendeur'])))
                    {
                    ...
                    ?>
                        <p class="text-center"> <i><?=(isset($_GET['identifiant_client']))?$nom:""; ?></i></p>
                        <h4 class="text-center">Commande :
                            <i><?=(isset($_GET['commande']))?$_GET['commande']:"";?></i><br>
                            <i><?=(isset($_GET['numero_vendeur']))?"Boutique : ".$info:" ";?></i><br>
                ...
                <div class="row partie_message">
                    ...
                    <?php
                        ...
                        {
                            if(isset($_GET['destine']) && $_GET['destine']=="client" )
                            {
                                $id_commande=$_GET['commande'];
                                $client= intval($_GET['identifiant_client']);
                                ...
                                if($select->rowcount() >0)
                                {
                                    ...
                                    $select->EXECUTE(array($id_commande,$client,$client,2147483647,2147483647));
                    ...
                    <div class="row bg-dark fixed-bottom" style="bottom:12px;float:right;position:fixed">
                        ...
                        <form
                            action="chat_envoi.php?sending_message=sending_message&amp;destinateure=client&amp;client=<?=$client;?>&amp;commande=<?=$id_commande;?>"
                    ...
                    <?php
                            ...
                            else if(isset($_GET['destine']) && $_GET['destine']=="vendeur" && isset($_GET["numero_vendeur"]) && is_int(intval($_GET["numero_vendeur"])) )
                            {
                                ...
                                if($select->rowcount() >0)
                                {
                                    ...
                                    $select=$bdd->PREPARE("SELECT * FROM chat WHERE  commande=? AND (id_client1=? or id_client2=?) AND (id_client1=? or id_client2=?) ");
                                    $select->EXECUTE(array($id_commande,2147483647,2147483647,$id_vendeur,$id_vendeur));
                    ...
                    <div class="row bg-dark fixed-bottom" style="bottom:12px;float:right;position:fixed">
                        ...
                        <form
                            action="chat_envoi.php?sending_message=sending_message&amp;destinataire=<?=$id_vendeur;?>&amp;commande=<?=$id_commande;?>"
